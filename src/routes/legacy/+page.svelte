...
<main class="min-h-screen bg-slate-900 px-4 py-5 text-slate-100 sm:px-6 sm:py-6">
  <div class="mx-auto max-w-5xl">
    <HubTopBar {gold} home="/legacy" />

    <p class="mt-6 rounded-xl border border-slate-700/60 bg-slate-800/40 px-4 py-2.5 text-[11px] text-slate-400">
      🗝️ <b class="font-extrabold text-slate-300">Legacy hub.</b> The home page is now the Gauntlet.
      <a href="/" class="font-bold text-amber-300 hover:text-amber-200">Go to the new home →</a>
    </p>
  ...
  <nav class="fixed inset-x-0 bottom-0 z-10 grid grid-cols-5 border-t border-slate-700/60 bg-slate-900/90 py-2 backdrop-blur sm:hidden">
    <a href="/legacy" class="grid justify-items-center gap-0.5 text-[10px] font-bold text-amber-300">
