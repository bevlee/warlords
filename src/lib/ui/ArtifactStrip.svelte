...
{#if items.length > 0}
  <div class="artifact-strip flex min-h-0 w-full flex-wrap content-start items-center justify-center gap-1.5 overflow-y-auto" role="list" aria-label="Army artifacts">
    ...
    {#each items as id (id)}
      ...
      <div class="group relative" role="listitem">
        <button
          ...
          class="flex min-h-8 items-center justify-center rounded-lg bg-slate-900/85 px-2 py-1 text-center text-[10px]
