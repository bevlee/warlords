...
export const ABILITY_INFO: Record<string, { label: string; description: string }> = {
  ...
  relentless: { label: 'Relentless', description: 'A primary melee kill sends this stack back into the order twice as soon.' },
  ...
  blood_rush: { label: 'Blood Rush', description: 'A primary melee kill sends Goblin back into the order twice as soon.' },
  ...
  quickdraw: { label: 'Quickdraw', description: 'A first-turn ranged attack sends Orc back into the order twice as soon.' },
  ...
  rampage: { label: 'Rampage', description: 'A primary melee kill lets Behemoth act again immediately.' },
  repair: { label: 'Repair', description: 'Active: heal and revive a wounded friendly construct.' },
  scrap_frenzy: { label: 'Scrap Frenzy', description: 'A shot that kills a creature sends Gremlin back into the order twice as soon.' },
