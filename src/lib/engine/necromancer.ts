...
export const NECROMANCER_UNITS: UnitDef[] = [
  ...
  },
  {
    ...
    shots: 0, range: 0, isLarge: false, abilities: ['undead', 'slow_on_hit', 'infecting_strike'],
  },
  {
  ...
  },
  {
    ...
    shots: 0, range: 0, isLarge: false, abilities: ['undead', 'life_drain', 'blood_frenzy'],
  ...
  },
  {
    ...
    shots: 0, range: 0, isLarge: false, abilities: ['undead', 'death_blow', 'soul_reaper'],
  },
  {
    name: 'Bone Dragon', tier: 7, speed: 8, initiative: 10, hp: 250,
    attack: 28, defense: 20, minDamage: 25, maxDamage: 45,
    shots: 0, range: 0, isLarge: false, abilities: ['undead', 'flying', 'defense_reduction', 'absorb_skeleton'],
  },
];
