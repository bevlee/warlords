...
const factionItems: ItemDef[] = [
  // Knight
  f('knight', 'muster_bell', 'Muster Bell', 'common', '[[militia]] gains its +1 Attack and Defence per 8 Peasants instead of per 10.', ['Peasant']),
  f('knight', 'blackpowder_fletching', 'Blackpowder Fletching', 'common', '[[area_shot]] hits for 65% of a normal shot instead of 50%. Friendlies are still caught in it.', ['Archer']),
  f('knight', 'drillmasters_manual', "Drillmaster's Manual", 'common', '[[focus]] grants +1 Attack and Defence on top of its usual +1 Initiative and damage.', ['Swordsman']),
  ...
  f('knight', 'barbed_volley', 'Barbed Volley', 'rare', '[[area_shot]] survivors lose 2 Defence until their next turn.', ['Archer']),
  f('knight', 'gryphon_talon_bracers', 'Gryphon Talon Bracers', 'rare', 'Griffin retaliations deal 50% more damage and bring its next turn 10% sooner.', ['Griffin']),
  f('knight', 'martyrs_banner', "Martyr's Banner", 'rare', 'The first Peasant stack destroyed permanently grants every living Knight stack +1 Initiative and +1 damage. Once per battle.', ['Peasant']),
  ...
  f('knight', 'royal_muster', 'Royal Muster', 'epic', 'A stack beside a Peasant stack gains half that stack’s [[militia]] bonus. Only one Peasant stack counts; they do not add up.', ['Peasant']),
  ...
  f('ranger', 'silver_horseshoe', 'Silver Horseshoe', 'common', "[[fortunes_herald]] grants +2 Luck instead of +1, and brings the next turn 40% sooner instead of 25%.", ['Unicorn']),
  f('ranger', 'quicksilver_dew', 'Quicksilver Dew', 'rare', 'Sprite has +4 Initiative.', ['Sprite']),
  f('ranger', 'pollen_veil', 'Pollen Veil', 'rare', 'Moving at least 3 cells halves the ranged damage Sprite takes until its next turn.', ['Sprite']),
  f('ranger', 'fleeting_shadow', 'Fleeting Shadow', 'rare', 'A [[darting_assault]] that returns with no enemy adjacent brings Sprite’s next turn 25% sooner.', ['Sprite']),
  f('ranger', 'endless_quiver', 'Endless Quiver', 'rare', 'Every shooter you own gains 6 extra shots, and a shooter’s [[wayfarers_compass]] move brings its next turn 65% sooner instead of 50%.', ['Wood Elf', 'Grand Elf']),
  f('ranger', 'predators_focus', "Predator's Focus", 'rare', 'Consecutive ranged hits build a 10% damage bonus up to 100%, pooled across your Wood Elf and Grand Elf stacks.', ['Wood Elf', 'Grand Elf']),
  ...
  f('ranger', 'horn_of_the_wild_hunt', 'Horn of the Wild Hunt', 'rare', 'Each Ranger melee stack’s first kill brings your other Ranger melee stacks’ next turns 15% sooner.'),
  f('ranger', 'rainbow_mane', 'Rainbow Mane', 'rare', 'Friendly good luck brings other Ranger stacks’ next turns 10% sooner.', ['Unicorn']),
  ...
  f('ranger', 'the_wild_hunt', 'The Wild Hunt', 'epic', 'Each Ranger stack’s first melee attack against an enemy yet to act deals 200% damage and comes back round twice as soon.'),
  ...
  f('barbarian', 'horde_drum', 'Horde Drum', 'rare', 'Each enemy death brings every friendly stack’s next turn 10% sooner, except the one currently acting.'),
  ...
  f('barbarian', 'horn_of_the_hunt', 'Horn of the Hunt', 'rare', 'Loose! grants 75% more ranged damage instead of 40%, and [[marking_shot|Marks]] the target before the damage lands.'),
  ...
  f('barbarian', 'endless_hunt', 'Endless Hunt', 'epic', 'A primary-attack kill sends the attacker back into the order twice as soon.'),
  ...
  f('barbarian', 'voice_of_the_warchief', 'Voice of the Warchief', 'epic', 'Battle Cries have 2 uses and bring the hero’s next turn twice as soon.'),
  f('barbarian', 'worldsplitter', 'Worldsplitter', 'epic', 'The hero deals 500% damage and surviving targets become Marked for Death.'),

  // Wizard
  f('wizard', 'ratchet_loader', 'Ratchet Loader', 'common', '[[scrap_frenzy]] brings Gremlin’s next turn 65% sooner instead of 50%.', ['Gremlin']),
  f('wizard', 'tinkers_kit', "Tinker's Kit", 'common', '[[repair]] may target any friendly stack, not only constructs.', ['Gremlin']),
  ...
  f('wizard', 'pressurised_bile_sac', 'Pressurised Bile Sac', 'common', '[[caustic_breath]] travels 5 cells instead of 3.', ['Bilehorn']),
  f('wizard', 'storm_fletching', 'Storm Fletching', 'common', '[[lightning_strike]] splash deals 90% instead of 75%.', ['Titan']),
  f('wizard', 'conduit_array', 'Conduit Array', 'rare', 'Stacks adjacent to a Mage inherit [[armour_piercing]].', ['Mage']),
  f('wizard', 'prism_of_the_fallen', 'Prism of the Fallen', 'rare', 'The hero deals 20% more damage per destroyed stack on the field, counting both armies, measured at the start of its turn.'),
  f('wizard', 'overcharged_rods', 'Overcharged Rods', 'rare', '[[lightning_strike]] removes retaliation until the target’s next turn.', ['Titan']),
  ...
  f('wizard', 'stormcrown', 'Stormcrown', 'epic', '[[lightning_strike]] covers a friendly-fire 5×5 area instead of 3×3.', ['Titan']),
  f('wizard', 'animus_engine', 'The Animus Engine', 'epic', '[[repair]] may rebuild each destroyed construct once.', ['Gremlin']),
  ...
  // Demon
  f('demon', 'powder_keg', 'Powder Keg', 'common', '[[cinderburst]] deals 40% of the stack’s starting HP instead of 25%.', ['Imp']),
  f('demon', 'sulfurous_pitch', 'Sulfurous Pitch', 'common', '[[hellfire_shot]] splash deals 75% instead of 50%.', ['Gog']),
  ...
  f('demon', 'furnace_heart', 'Furnace Heart', 'rare', 'A burning stack’s death spreads [[burn]] to every adjacent stack, your own included, unless it is immune to fire.'),
  ...
  f('demon', 'ashen_covenant', 'Ashen Covenant', 'rare', 'Each of your Demon stacks, as it dies, brings every other stack’s next turn 10% sooner. Once per stack.'),
  f('demon', 'devils_contract', "Devil's Contract", 'rare', 'A [[doomstep]] kill sends Devil back into the order twice as soon.', ['Devil']),
  ...
  f('demon', 'seal_of_the_ninth_circle', 'Seal of the Ninth Circle', 'epic', 'Each starting Demon stack returns once after death at 30% of its starting count, or 60% if it already has [[infernal_rebirth]].'),
  ...
  f('necromancer', 'plague_bell', 'Plague Bell', 'common', 'Corpses carrying [[infecting_strike]] raise twice as many Skeletons.', ['Zombie']),
  ...
  f('necromancer', 'chalice_of_night', 'Chalice of Night', 'common', 'Vampire [[life_drain]] heals 150% of damage dealt instead of 100% against a target carrying any negative effect, negative morale, or burning.', ['Vampire']),
  f('necromancer', 'withered_quiver', 'Withered Quiver', 'common', '[[curse_shot]] also applies −5 Defence.', ['Lich']),
  f('necromancer', 'reapers_tack', "Reaper's Tack", 'common', '[[soul_reaper]] claims 2 additional creatures.', ['Black Knight']),
  f('necromancer', 'vertebral_key', 'Vertebral Key', 'common', '[[absorb_skeleton]] sends Bone Dragon back into the order twice as soon.', ['Bone Dragon']),
  f('necromancer', 'book_of_grudges', 'Book of Grudges', 'rare', 'Every stack you own deals 15% more damage per negative effect on the target, counting negative morale and burning.'),
  f('necromancer', 'blighted_soil', 'Blighted Soil', 'rare', 'A dead enemy carrying [[infecting_strike]] spreads it to the enemies around it.', ['Zombie']),
  ...
  f('necromancer', 'funeral_drum', 'Funeral Drum', 'rare', 'Every 5 Skeletons you lose brings your other Necromancer stacks’ next turns 10% sooner. Leftovers carry over.'),
  ...
  f('necromancer', 'shroud_of_preservation', 'Shroud of Preservation', 'rare', 'Half of a destroyed Skeleton stack joins your largest surviving Skeleton stack.', ['Skeleton']),
  ...
  f('necromancer', 'red_moon_covenant', 'Red Moon Covenant', 'epic', '[[blood_frenzy]] and [[life_drain]] are doubled.', ['Blood Acolyte', 'Vampire']),
  f('necromancer', 'the_black_procession', 'The Black Procession', 'epic', 'Raised Skeletons gain [[infecting_strike]] and [[drain_morale]].'),
];
