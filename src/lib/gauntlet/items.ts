...
const factionItems: ItemDef[] = [
  ...
  f('wizard', 'tinkers_kit', "Tinker's Kit", 'common', '[[repair]] may target any living friendly stack, not only [[construct|Constructs]]. It cannot revive a [[perished]] stack.', ['Gremlin']),
  ...
  f('wizard', 'storm_fletching', 'Storm Fletching', 'common', '[[lightning_strike]] hits only enemies and its splash deals 90% instead of 75%.', ['Titan']),
  ...
  f('demon', 'ashen_covenant', 'Ashen Covenant', 'rare', 'The first time each friendly Demon stack [[perished|perishes]], every other living friendly stack advances 10% [[atb]].'),
  ...
  f('demon', 'seal_of_the_ninth_circle', 'Seal of the Ninth Circle', 'epic', 'The first time each starting Demon stack [[perished|perishes]], it returns with 30% of its starting creatures, or 60% if it has [[infernal_rebirth]].'),
  f('demon', 'hells_verdict', "Hell's Verdict", 'epic', '[[doomstep]] against a burning target deals 50% Fire damage to every adjacent enemy.', ['Devil']),
  ...
  f('necromancer', 'plague_bell', 'Plague Bell', 'common', 'Gravewright’s Grimoire raises twice as many creatures from enemy stacks carrying [[infecting_strike]].', ['Zombie']),
