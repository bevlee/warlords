...
const factionItems: ItemDef[] = [
  ...
  f('knight', 'drillmasters_manual', "Drillmaster's Manual", 'common', '[[focus]] grants +1 Attack and Defense on top of its usual +1 Initiative and damage.', ['Swordsman']),
  ...
  f('knight', 'barbed_volley', 'Barbed Volley', 'rare', '[[area_shot]] survivors lose 2 Defense until their next turn.', ['Archer']),
